...
// https://esm.sh/v102/scheduler@0.23.0/deno/scheduler.js
...
// https://esm.sh/v102/react-dom@18.2.0/deno/client.js
...
// App.tsx
function App() {
  const [counter, setCounter] = Me(0);
  De(() => {
    console.log("didmount in browser");
  }, []);
  return /* @__PURE__ */ We.createElement("div", null, /* @__PURE__ */ We.createElement("h1", null, "Hello World"), /* @__PURE__ */ We.createElement("h2", null, counter), /* @__PURE__ */ We.createElement("div", null, /* @__PURE__ */ We.createElement("button", {
    onClick: () => setCounter(counter - 1)
  }, "-1"), /* @__PURE__ */ We.createElement("button", {
    onClick: () => setCounter(counter + 1)
  }, "+1")));
}

// entry-client.js
var el = Re(App, null, null);
jf(document, el);
